...
//			else
//			{
//				graph_with_time_span_non_hop_constrained = graph_v_of_v_with_time_span_non_hop_constrained<int>(v_num, e_num, upper, lower, change_num);
