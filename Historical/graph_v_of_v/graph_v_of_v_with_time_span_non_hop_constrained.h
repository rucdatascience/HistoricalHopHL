...
class graph_v_of_v_with_time_span_non_hop_constrained : public graph_v_of_v_with_time_span
{
private:
public:
	graph_v_of_v_with_time_span_non_hop_constrained<weight_type>() : graph_v_of_v_with_time_span() {};
	graph_v_of_v_with_time_span_non_hop_constrained<weight_type>(int n, int e, weight_type weight_upper_limit, weight_type weight_lower_limit, int time_max) : graph_v_of_v_with_time_span(n, e, weight_upper_limit, weight_lower_limit, time_max) {
	};
